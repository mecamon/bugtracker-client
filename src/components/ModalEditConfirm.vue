<template>
  <div class="modal-bg">
    <div class="modal">
      <h2 class="success-text" v-if="success">Company edited!</h2>
      <div class="safe-area" v-if="!success">
        <div id="title">
          <h3>Changes confirmation</h3>
        </div>
...
export default {
  ...
  methods: {
    closeModal() {
      this.$store.commit('companies/switchEditConfirmModalVisibility', false);
    },
     saveChanges(payload) {
